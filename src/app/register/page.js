  ...
  return (
    <div className="bg-white relative">
      <div className="flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-8 mr-auto xl:px-5 lg:flex-row">
        <div className="flex flex-col justify-center items-center w-full lg:pr-10 lg:pl-10 sm:pr-7 sm:pl-7 lg:flex-row">
          <div className="w-full mt-10 mr-0 mb-0 ml-0 relative max-w-2xl lg:mt-0 lg:w-5/12">
            <div className="flex flex-col items-center justify-start pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10 sm:object-cover sm:visible text-black">
              <p className="w-full text-4xl font-medium text-center font-serif sm:object-cover sm:visible text-black">
                {isRegistered
